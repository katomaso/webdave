...
class WebdavNavigator extends LitElement {
	...
	constructor() {
		...
		this.sort = WebdavNavigator.sortOptions[0]; // first is the default
...
customElements.define('webdav-navigator', WebdavNavigator);
